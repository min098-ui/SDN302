          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-base font-bold text-rose-900 flex items-center gap-2">
                <span>Xác nhận xóa nhiệm vụ</span>
              </h3>
              <p className="text-xs text-rose-600/80">Hành động này không thể hoàn tác</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6">
          <div className="flex items-start gap-3.5 p-4 rounded-2xl bg-rose-50/70 border border-rose-200/60 mb-5">
            ...
            <div className="text-xs text-rose-800 leading-relaxed">
              Bạn có chắc chắn muốn xóa nhiệm vụ này khỏi hệ thống cơ sở dữ liệu Supabase không?
            </div>
          </div>

          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200/70 mb-6">
            <p className="text-xs text-slate-500 font-semibold mb-1">Nhiệm vụ:</p>
